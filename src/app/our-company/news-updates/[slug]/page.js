        ...
        <section className="news-hero relative">
          <div className="container-fluid blog-hero-content">
            ...
            <div className="blog-banner-content absolute top-0 p-5 lg:p-10 flex flex-col gap-3">
              ...
              {/* Title */}
              <h1 className="fade-text w-9/12 text-white">{post.title}</h1>
    ...
    <div className="flex items-center gap-2">
      ...
      <div className="flex gap-1">
        ...
        >
          ...
          >
            <path
              d="M12.0013 1.33203H10.0013C9.11725 1.33203 8.2694 1.68322 7.64428 2.30834C7.01916 2.93346 6.66797 3.78131 6.66797 4.66536V6.66536H4.66797V9.33203H6.66797V14.6654H9.33464V9.33203H11.3346L12.0013 6.66536H9.33464V4.66536C9.33464 4.48855 9.40487 4.31898 9.5299 4.19396C9.65492 4.06894 9.82449 3.9987 10.0013 3.9987H12.0013V1.33203Z"
              fill="#DA000E"
            />
          </svg>
        </a>
        ...
        >
          ...
          >
            <path
              d="M10.666 5.33203C11.7269 5.33203 12.7443 5.75346 13.4944 6.5036C14.2446 7.25375 14.666 8.27117 14.666 9.33203V13.9987H11.9993V9.33203C11.9993 8.97841 11.8589 8.63927 11.6088 8.38922C11.3588 8.13917 11.0196 7.9987 10.666 7.9987C10.3124 7.9987 9.97326 8.13917 9.72321 8.38922C9.47316 8.63927 9.33268 8.97841 9.33268 9.33203V13.9987H6.66602V9.33203C6.66602 8.27117 7.08744 7.25375 7.83759 6.5036C8.58773 5.75346 9.60515 5.33203 10.666 5.33203Z"
              fill="#DA000E"
            />
            <path d="M4.00065 6H1.33398V14H4.00065V6Z" fill="#DA000E" />
            <path
              d="M2.66732 3.9987C3.4037 3.9987 4.00065 3.40174 4.00065 2.66536C4.00065 1.92898 3.4037 1.33203 2.66732 1.33203C1.93094 1.33203 1.33398 1.92898 1.33398 2.66536C1.33398 3.40174 1.93094 3.9987 2.66732 3.9987Z"
              fill="#DA000E"
              stroke="#DA000E"
              strokeLinecap="round"
        ...
        >
          ...
          >
            <g clipPath="url(#clip0_370_2077)">
              ...
              />
              <path
                d="M12.9993 2.5L8.88184 7.02938"
                stroke="#DA000E"
                strokeWidth="1.5"
                strokeLinecap="round"
                strokeLinejoin="round"
