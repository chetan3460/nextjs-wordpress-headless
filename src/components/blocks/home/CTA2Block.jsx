        ...
        <div className="main-container">
          <div className="bg-background-5 relative flex items-center justify-between overflow-hidden rounded-lg p-7 lg:p-20 xl:p-[100px]">
            <div className="space-y-1.5 sm:max-w-[400px] lg:max-w-[567px] lg:space-y-3">
              ...
              <div className="mt-6 md:mt-12" data-opai-animate data-delay="0.6" data-duration="0.7">
            ...
            <div className="cta-v2-images-wrapper">
              <figure className="cta-v2-image-1 absolute right-0 -bottom-1 z-3 max-h-[406px] max-w-[120px] overflow-hidden sm:max-w-[150px] md:max-w-[250px] md:rounded-xl lg:right-5 lg:max-w-[320px] xl:right-25 xl:max-w-[360px]">
                <img
              ...
              <figure className="cta-v2-image-2 absolute right-26 -bottom-3 z-2 hidden max-h-[345px] max-w-[130px] -rotate-[15deg] overflow-hidden sm:block md:max-w-[220px] md:rounded-xl lg:right-40 lg:max-w-[280px] xl:right-60 xl:max-w-[317px]">
                <img
              ...
              <figure className="cta-v2-image-3 absolute right-50 bottom-0 z-1 hidden max-h-[261px] max-w-[190px] -rotate-[30deg] overflow-hidden rounded-xl md:block lg:right-100 lg:max-w-[150px] xl:max-w-[226px]">
                <img
