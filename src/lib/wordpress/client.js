...
async function processACFImages(acf) {
    ...
    const keysToHydrate = ['image', 'images', 'icon', 'logo', 'banner_images', 'mobile_image', 'desktop_image', 'inner_banner_image', 'certificate_image', 'certificate_popup_image', 'leaders_image'];
